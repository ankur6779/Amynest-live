...
const ROLE_SHOTS: Record<DirectorBeatRole, ShotRecipe> = {
  ...
  problem: {
    ...
    composerCamera: "Hold",
    framing: "Hold on the recognizable parenting friction beat",
    subjectFraming: "Parent and child sharing the frame; tension readable muted",
  },
  emotion: {
    shotType: "Close-Up",
    shotSize: "close-up",
  ...
  cta: {
    ...
    framing: "Soft settle before end card; hope already earned",
    subjectFraming: "Amy AI warm presence; CTA readable without shouting",
  },
  "end-card": {
    shotType: "Wide Shot",
    shotSize: "wide",
