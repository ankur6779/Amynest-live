...
export function exportWorkflowResult(
  ...
  switch (format) {
    ...
    case "workflow-report-v1":
      return {
        format: "workflow-report-v1",
        ...
        contentType: "application/vnd.amynest.workflow-report.v1+json",
      };
    default: {
      const _exhaustive: never = format;
      throw new Error(`Unsupported workflow export format: ${_exhaustive}`);
    }
  }
}
