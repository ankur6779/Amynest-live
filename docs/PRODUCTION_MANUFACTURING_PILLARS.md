...
| Parent Hub | Pack 2 Living Rooms shipped behind `VITE_FF_PARENT_HUB_ROOMS_V1` — review `docs/v2/PARENT_HUB_PACK2_FOUNDER_REVIEW.md` — **Pack 3 only after Founder approval** |
