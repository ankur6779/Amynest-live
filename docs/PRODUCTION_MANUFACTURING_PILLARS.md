...
| Parent Hub | Pack 4.6 Intelligence Policy `docs/v2/PARENT_HUB_PACK4_6_INTELLIGENCE_POLICY.md` — **permanent rulebook; no intel code / Pack 5 until Founder approval** |
