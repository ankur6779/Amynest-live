...
| Parent Hub | Constitution · Visual study · Manufacturing plan `docs/v2/PARENT_HUB_MANUFACTURING_PLAN.md` — **B0 Blueprint then Pack 1+ only after Founder approval; no Hub code yet** |
