...
| Parent Hub | Pack 4 APPROVED · Pack 4.5 Intelligence study `docs/v2/PARENT_HUB_PACK4_5_INTELLIGENCE.md` — **no intel implementation / Pack 5 until Founder approval** |
