...
| Parent Hub | Pack 3 Destinations shipped behind `VITE_FF_PARENT_HUB_ROOMS_V1` — review `docs/v2/PARENT_HUB_PACK3_FOUNDER_REVIEW.md` — **Pack 4 only after Founder approval** |
