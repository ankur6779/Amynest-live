...
GCS_SERVICE_ACCOUNT_JSON_B64=${GCS_SERVICE_ACCOUNT_JSON_B64:-}
...
AI_JOB_TIMEOUT_MS=${AI_JOB_TIMEOUT_MS:-60000}
MEALS_AI_OPENAI_TIMEOUT_MS=${MEALS_AI_OPENAI_TIMEOUT_MS:-40000}
MEALS_AI_MAX_COMPLETION_TOKENS=${MEALS_AI_MAX_COMPLETION_TOKENS:-1500}
