  ...
  L({
    ...
    paragraphs: {
      ...
      hinglish: [
        ...
        "12 mahine tak: naam par response, ishaare ko follow karna, babbling, madad se khade hona. 18 mahine tak: ek shabd, chalna, maangne ke liye point karna, simple play. 2 saal tak: do-shabdon ke phrases, daudna, aapki nakal karna. 3 saal tak: chhote sentences, tricycle, zyaadatar din bina meltdown alag hona. 4 saal tak: chhoti kahani batana, insaan ka chitra do body parts ke saath, ek pair par hop.",
        "Red flags jin par usi hafte paediatric review chahiye: 12 mahine tak babbling nahi, 16 mahine tak ek shabd nahi, 24 mahine tak do-shabdon ke phrases nahi, kisi bhi umra mein pehle ki skills kho dena, eye contact nahi, 12 mahine tak naam par react nahi, sirf panjon par chalna, hand flapping, khilonon ko baar-baar line karna, ya bhai-behen ke muqable badi der.",
        "Sabse bada brain-builder hai serve-and-return: baby coo kare, aap coo back karein. Toddler kutte ki taraf point kare, aap kahein 'haan, bada bhoora kutta'. Yeh back-and-forth — flashcards ya apps nahi — language aur social brain banata hai. Harvard Center on the Developing Child ki 30 saal ki evidence hai: in tiny exchanges ki quality kisi bhi toy se zyaada cognition predict karti hai.",
        "Agar kuch theek nahi lagta, gut par bharosa karein. 3 saal se pehle early intervention autism, speech delay, motor delay aur learning differences ki lifelong trajectory badal deti hai. Normal evaluation aashwasan deti hai. Early diagnosis madad shuru kar deti hai. Dono jeet hain. Haar sirf wait-and-watch mein hai.",
      ],
    },
  }),
  ...
  L({
    ...
    paragraphs: {
      ...
      hi: [
        ...
        "Rule 4: environment हर बार willpower को हरा देता है। घर में जो है वही खाया जाता है। Restock करें, police नहीं। मिठाई और chips नज़र से हटाएं। Counter पर फल का bowl रखें। Table par family meals — बिना screen के — हफ्ते में 3+ बार healthy weight का सबसे मज़बूत evidence-based predictor है। Doctor कब: BMI 95th+ percentile, गर्दन पर velvety त्वचा, खर्राटे, घुटनों में दर्द — proper assessment मांगें। यह medicine है, parenting failure नहीं।",
      ],
      hinglish: [
        "Bharat mein childhood obesity 20 saal mein teen guna ho gayi hai. Urban bacche ab Western kids jitne risk par hain. Lekin zyaadatar families jo tarika apnaati hain — restriction, dieting, lecturing — asal mein backfire karta hai. Decades ki research dikhati hai ghar par diet karaye gaye bacchon mein teen years mein weight problems aur disordered eating ZYAADA likely hote hain. 2023 AAP guideline ka solution ulta hai: family-based behaviour change, child-targeted restriction nahi.",
        ...
        "Rule 2: AAP-endorsed 5-2-1-0 daily target — pure parivar ke liye. 5 servings phal-sabzi. 2 ghante ya kam recreational screen time. 1 ghanta active play. Zero sugary drinks — juice, sweetened doodh, sodas, energy drinks ke saath. Yeh kaam karta hai kyunki focus JODNE par hai.",
        "Rule 3: Ellyn Satter ki Division of Responsibility. Parents tay karte hain KYA khaana diya jaata hai, KAB, KAHAN. Bacha tay karta hai khaana hai ya nahi, aur kitna. Koi bribing nahi, koi forcing nahi, koi 'plate khatam karo' nahi. Unki bhookh aur fullness par bharosa karein.",
        "Rule 4: environment har baar willpower ko haraata hai. Ghar mein jo hai wahi khaaya jaata hai. Mithai aur chips najar se hatayein. Counter par phal ka bowl rakhein. Table par family meals bina screen ke hafte mein 3+ baar. Doctor kab: BMI 95th+ percentile, gardan ki silwaton mein kaali velvety skin, snoring with pauses, ghutnon mein dard — proper assessment maango. Yeh medicine hai, parenting failure nahi.",
      ],
    },
  }),
  L({
    ...
    paragraphs: {
      ...
      hi: [
        ...
        "आदत 3: दूरी और posture। Tablet और phone arm's length पर। Monitor का top eye level पर ताकि सिर नीचे न झुके। पैर ज़मीन पर flat। क्यों? 60 degree आगे झुका सिर developing cervical spine पर 27 kg load डालता है। सालों यही = tech-neck, headaches, chronic pain। Proper distance पर बड़ी screens बेहतर हैं।",
        "आदत 4: सोने से ठीक 1 घंटे पहले कोई screen नहीं। तेज़ screen light melatonin दबाती है और बच्चों में sleep onset 30-60 मिनट देर करती है। आख़िरी घंटा wind-down ritual से बदलें: गर्म स्नान, dim lights, ज़ोर से पढ़ाना, gentle stretches, music। Eye doctor कब: squint करे, screen बहुत पास रखे, पढ़ते समय सिर tilt करे, headaches की शिकायत करे, या marks में अचानक गिरावट हो।",
      ],
      hinglish: [
        ...
        "Aadat 1: 20-20-20 rule, game ki tarah sikhayein. Har 20 minute screen par, 20-second ka break aur 20 feet door dekho. Kyon? Lambe samay tak paas focus karna myopia badhane ka sabse bada known driver hai. Ek soft alarm rakhein. Family ritual banayein. 20-second ka break bhi focusing muscles ko reset karta hai.",
        "Aadat 2: roz kam se kam 2 ghante ki dhoop wali bahar ki activity. Yeh myopia-protection ka sabse evidence-based factor hai. Tez dhoop retina mein dopamine release karti hai jo eyeball ki elongation dheemi karti hai jo short-sight karti hai. Exercise zaruri nahi — bahar padhna bhi madad karta hai. Tahlein, balcony par snack khayein, ek outdoor sport khojein.",
        "Aadat 3: doori aur posture. Tablet aur phone arm's length par. Monitor ka top eye-level par taaki sar neeche na jhuke. Pair zameen par flat. 60 degree aage jhuka sar developing cervical spine par 27 kg load daalta hai. Saalon yahi = tech-neck, headaches, chronic pain. Proper distance par badi screens chhoti screens se aankhon ke liye bahut behtar hain.",
        "Aadat 4: sone se theek 1 ghante pehle koi screen nahi. Tez screen light melatonin dabati hai aur bacchon mein sleep onset 30-60 minute der karti hai. Aakhri ghanta wind-down ritual se badlein: garam snaan, dim lights, zor se padhna, gentle stretches, music. Eye doctor kab: bacha squint kare, screen ya kitaab bahut paas rakhe, padhte samay sar tilt kare, headaches ki shikayat kare, ya marks mein achanak girawat ho.",
      ],
    },
  }),
  ...
  L({
    ...
    paragraphs: {
      ...
      hi: [
        ...
        "गलतियों की उम्मीद रखें। भूली हुई lunch, छूटा homework, बुरा grade। ये छोटी विफलताएं सबसे सस्ती पाठशाला हैं। बचा लेंगे तो lesson चुरा लेंगे।",
      ...
      hinglish: [
        ...
        "Galtiyon ki umeed rakhein. Bhooli hui lunch, chhuta homework, bura grade. Ye chhoti failures sabse sasti paathshaala hain. Bachaa lenge toh lesson chura lenge.",
        "Bachane ki ichha rokein. Shikaayat par aapka script: 'Yeh mushkil lagta hai. Tum kya karoge?' Aap problem-solver ko coach kar rahe hain, problem solve nahi.",
  ...
  L({
    ...
    paragraphs: {
      ...
      hi: [
        ...
        "सबसे जरूरी: सिर्फ हटाएं नहीं, बदलें। 'No phone' परिवारों में जो teens सबसे अच्छे रहते हैं — उनके parents उस समय को खेल, दोस्त, hobby, काम और बाहरी गतिविधियों से भरते हैं। Phone ज़रूरत नहीं — उसके नीचे की ज़रूरत है connection।",
      ],
      hinglish: [
        ...
        "Sabse zaroori: sirf hatayen nahi, badlein. 'No phone' parivaron mein jo teens sabse achhe rehte hain — unke parents us time ko sport, dost, hobby, kaam aur bahari activities se bharte hain. Phone zarurat nahi — uske neeche ki zarurat hai connection.",
      ],
    },
  }),
  L({
  ...
  L({
    ...
    paragraphs: {
      ...
      hinglish: [
        ...
        "Warning signs jo professional baatcheet ki zarurat batate hain: 2 hafte se zyaada lagaataar udaasi, pehle pasand ki activities se doori, neend ya bhookh mein bada badlaav, grades girna, bojh hone ki baatein, niraasha, ya self-harm/suicide ka koi zikr.",
