 ...
 */
export const getGetSpeechMilestonesUrl = (
  params: GetSpeechMilestonesParams,
) => {
  const normalizedParams = new URLSearchParams();
...
export const getGetSpeechMilestonesQueryKey = (
  params?: GetSpeechMilestonesParams,
) => {
  return [`/api/speech/milestones`, ...(params ? [params] : [])] as const;
};

export const getGetSpeechMilestonesQueryOptions = <
  TData = Awaited<ReturnType<typeof getSpeechMilestones>>,
  TError = ErrorType<unknown>,
>(
  params: GetSpeechMilestonesParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getSpeechMilestones>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetSpeechMilestonesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSpeechMilestones>>
  > = ({ signal }) =>
    getSpeechMilestones(params, { signal, ...requestOptions });
...
export type GetSpeechMilestonesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSpeechMilestones>>
>;
...
export function useGetSpeechMilestones<
  TData = Awaited<ReturnType<typeof getSpeechMilestones>>,
  TError = ErrorType<unknown>,
>(
  params: GetSpeechMilestonesParams,
...
export const setSpeechMilestoneStatus = async (
  id: string,
  setSpeechMilestoneStatusBody: SetSpeechMilestoneStatusBody,
  options?: RequestInit,
): Promise<SpeechMilestoneStatusEntry> => {
  return customFetch<SpeechMilestoneStatusEntry>(
    getSetSpeechMilestoneStatusUrl(id),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getSetSpeechMilestoneStatusMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SetSpeechMilestoneStatusMutationResult = NonNullable<
  Awaited<ReturnType<typeof setSpeechMilestoneStatus>>
>;
export type SetSpeechMilestoneStatusMutationBody =
  BodyType<SetSpeechMilestoneStatusBody>;
export type SetSpeechMilestoneStatusMutationError = ErrorType<unknown>;

/**
 * @summary Update the per-child status for a speech milestone
 */
export const useSetSpeechMilestoneStatus = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
 ...
 */
export const getGetSpeechPracticePromptsUrl = (
  params: GetSpeechPracticePromptsParams,
) => {
  const normalizedParams = new URLSearchParams();
...
export const getSpeechPracticePrompts = async (
  params: GetSpeechPracticePromptsParams,
  options?: RequestInit,
): Promise<SpeechPracticePromptsResponse> => {
  return customFetch<SpeechPracticePromptsResponse>(
    getGetSpeechPracticePromptsUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getGetSpeechPracticePromptsQueryKey = (
  params?: GetSpeechPracticePromptsParams,
) => {
...
export const getGetSpeechPracticePromptsQueryOptions = <
  TData = Awaited<ReturnType<typeof getSpeechPracticePrompts>>,
  TError = ErrorType<unknown>,
>(
  params: GetSpeechPracticePromptsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getSpeechPracticePrompts>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetSpeechPracticePromptsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSpeechPracticePrompts>>
  > = ({ signal }) =>
    getSpeechPracticePrompts(params, { signal, ...requestOptions });
...
export type GetSpeechPracticePromptsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSpeechPracticePrompts>>
>;
...
export function useGetSpeechPracticePrompts<
  TData = Awaited<ReturnType<typeof getSpeechPracticePrompts>>,
  TError = ErrorType<unknown>,
>(
  params: GetSpeechPracticePromptsParams,
...
export const getLogSpeechPracticeAttemptMutationOptions = <
  TError = ErrorType<FeatureLockedError>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type LogSpeechPracticeAttemptMutationError =
  ErrorType<FeatureLockedError>;
...
export const getSpeechProgress = async (
  ...
  options?: RequestInit,
): Promise<SpeechProgressResponse> => {
