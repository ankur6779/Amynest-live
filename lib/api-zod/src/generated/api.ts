...
export const ListChildrenResponseItem = zod.object({
  ...
  "educationStage": zod.string().nullish().describe('Education stage code (at_home, nursery, lkg, ukg, playgroup, school, etc.)'),
  "learningEnvironment": zod.string().nullish().describe('Learning environment (home, daycare, early_learning, formal_school, homeschool)'),
  "scheduleKnown": zod.boolean().nullish().describe('Whether formal school schedule times are confirmed by the parent'),
  "age": zod.number(),
...
export const CreateChildBody = zod.object({
  ...
  "educationStage": zod.string().nullish(),
  "learningEnvironment": zod.string().nullish(),
  "scheduleKnown": zod.boolean().nullish(),
  "age": zod.number(),
