...
export const PURCHASE_CTAS = {
  ...
  successTitle: "The full system is yours",
  successBody:
...
export const UPGRADE_MODAL = {
  title: "Unlock the system you've started",
  subtitle:
    "You've touched one piece—AmyNest works best when AI, Coach, Speech, learning, routines, and Hub work together for your child.",
  cta: PURCHASE_CTAS.default,
  dismiss: "Not now",
} as const;

export const PAYWALL_AI = {
  title: "You don't have to figure this moment out alone",
  subtitle:
    "Amy AI gives calm, specific guidance for meltdowns, homework battles, and bedtime—grounded in parenting, not chatbot noise. Parents with full access respond faster and stress less.",
  cta: "Unlock Amy AI",
} as const;
...
export const PAYWALL_SPEECH_COACH = {
  ...
  subtitle:
    "Speech Coach practices sounds and sentences with your child—so participation at school and confidence at home aren't left to chance.",
  cta: "Unlock Speech Coach",
} as const;

export const PAYWALL_LEARNING = {
  title: "Don't let their learning pause here",
  subtitle:
    "Adaptive paths, fresh activities, and progress that compounds—full access keeps momentum between school terms.",
...
export const PAYWALL_ROUTINES = {
  title: "Calmer days start with a plan",
  subtitle:
...
export const ANNUAL_POSITIONING_CONCEPTS = [
  ...
  "The math parents notice: $3.33/month vs $4.99—full system either way.",
...
> = {
  ...
  coach_locked: {
    ...
    subtitle:
      "Amy Coach turns tantrums, defiance, screens, and sleep struggles into 10–12 clear steps—for your child's age, not the internet's average kid.",
  ...
  premium_insight: {
    title: "See the pattern before the next hard day",
    subtitle:
      "Behavior insights connect dots across wins and meltdowns—so your response builds trust, not tension.",
    cta: "Unlock insights",
  },
  child_limit: {
  ...
  behavior_locked: {
    title: "Log once. Parent smarter forever after.",
    subtitle:
  ...
  phonics_workbook: {
    ...
    subtitle:
      "Printable phonics and worksheets—practice together without another subscription.",
    cta: "Unlock workbooks",
  },
  hub_nutrition: {
    title: "Meals that match your family's reality",
    subtitle:
