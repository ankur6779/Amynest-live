...
export function prettyAuthError(err: unknown): string {
  ...
  switch (code) {
    ...
    case "auth/unauthorized-continue-uri":
      return "Verification link domain is not allowed. Add amynest.in under Firebase → Authentication → Settings → Authorized domains, and set the email template action URL to https://amynest.in/verify-email";
