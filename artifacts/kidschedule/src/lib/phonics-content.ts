...
const LEVEL_2_3Y: PhonicsLevel = {
  ...
  items: [
    // Pure synthetic-phonics labels: stops are short and clipped (no "-uh"
    // schwa); continuants stretch (fff, mmm). Examples begin with the taught
    // short-vowel / consonant phoneme (no "Ice" for short i, "Arm" for short a).
    { id: "bp-a", symbol: "A", sound: "A says a as in apple", phoneme: "a",   example: "Apple",   examples: ["Apple","Ant","Axe"],            emoji: "🍎" },
    { id: "bp-b", symbol: "B", sound: "B says b",   phoneme: "b",   example: "Ball",    examples: ["Ball","Bat","Banana","Bear"],   emoji: "⚽" },
    { id: "bp-c", symbol: "C", sound: "C says k",   phoneme: "k",   example: "Cat",     examples: ["Cat","Cup","Cot"],              emoji: "🐱" },
    { id: "bp-d", symbol: "D", sound: "D says d",   phoneme: "d",   example: "Dog",     examples: ["Dog","Duck","Door"],            emoji: "🐶" },
    { id: "bp-e", symbol: "E", sound: "E says e as in egg", phoneme: "e",    example: "Egg",     examples: ["Egg","Elephant","Elbow"],       emoji: "🥚" },
    { id: "bp-f", symbol: "F", sound: "F says fff", phoneme: "f",   example: "Fish",    examples: ["Fish","Fan","Frog","Foot"],     emoji: "🐟" },
    { id: "bp-g", symbol: "G", sound: "G says g",   phoneme: "g",   example: "Goat",    examples: ["Goat","Gift","Grape"],          emoji: "🐐" },
    { id: "bp-h", symbol: "H", sound: "H says h",   phoneme: "h",   example: "Hat",     examples: ["Hat","House","Horse"],          emoji: "🎩" },
    { id: "bp-i", symbol: "I", sound: "I says i as in igloo", phoneme: "i",  example: "Igloo",   examples: ["Igloo","Insect","In"],          emoji: "🧊" },
    { id: "bp-j", symbol: "J", sound: "J says j",   phoneme: "j",   example: "Jug",     examples: ["Jug","Jam","Jeep"],             emoji: "🫙" },
    { id: "bp-k", symbol: "K", sound: "K says k",   phoneme: "k",   example: "Kite",    examples: ["Kite","King","Key"],            emoji: "🪁" },
    { id: "bp-l", symbol: "L", sound: "L says lll", phoneme: "l",   example: "Lion",    examples: ["Lion","Leaf","Leg"],            emoji: "🦁" },
    { id: "bp-m", symbol: "M", sound: "M says mmm", phoneme: "m",   example: "Mat",     examples: ["Mat","Mango","Mum"],            emoji: "🧶" },
    { id: "bp-n", symbol: "N", sound: "N says nnn", phoneme: "n",   example: "Nest",    examples: ["Nest","Nose","Nut"],            emoji: "🪺" },
    { id: "bp-o", symbol: "O", sound: "O says o as in octopus", phoneme: "o", example: "Octopus", examples: ["Octopus","Ox","On"],           emoji: "🐙" },
    { id: "bp-p", symbol: "P", sound: "P says p",   phoneme: "p",   example: "Pig",     examples: ["Pig","Pen","Pot","Pan"],        emoji: "🐷" },
    { id: "bp-q", symbol: "Q", sound: "Q says kw",  phoneme: "q",   example: "Queen",   examples: ["Queen","Quilt","Quick"],        emoji: "👑" },
    { id: "bp-r", symbol: "R", sound: "R says rrr", phoneme: "r",   example: "Rat",     examples: ["Rat","Rabbit","Ring"],          emoji: "🐀" },
    { id: "bp-s", symbol: "S", sound: "S says sss", phoneme: "s",   example: "Sun",     examples: ["Sun","Snake","Star","Sock"],    emoji: "☀️" },
    { id: "bp-t", symbol: "T", sound: "T says t",   phoneme: "t",   example: "Tap",     examples: ["Tap","Tiger","Top"],            emoji: "🚰" },
    ...
    { id: "bp-w", symbol: "W", sound: "W says w",   phoneme: "w",   example: "Water",   examples: ["Water","Wind","Wolf"],          emoji: "💧" },
    ...
    { id: "bp-z", symbol: "Z", sound: "Z says zzz", phoneme: "z",   example: "Zebra",   examples: ["Zebra","Zoo","Zip"],            emoji: "🦓" },
  ],
  features: {},
  parentTips: [
    "Say the SOUND (a short, crisp /b/), not the LETTER NAME ('bee') — and avoid adding 'uh' after it ('buh'). This is real phonics.",
