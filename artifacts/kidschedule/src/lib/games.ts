...
export const GAMES: GameDef[] = [
  { id: "pattern-match",    title: "Pattern Match",    category: "brain",     emoji: "🧩", blurb: "Spot the rule, then tap what comes next — great warm-up for maths thinking.",              unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 5–8" },
  { id: "odd-one-out",      title: "Odd One Out",      category: "brain",     emoji: "🔍", blurb: "Compare carefully and find the one that does not belong.",                   unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 5–8" },
  { id: "card-flip",        title: "Card Flip Match",  category: "memory",    emoji: "🃏", blurb: "Flip two cards at a time and remember where the pairs hide.",          unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 4–7" },
  { id: "sequence",         title: "Sequence Memory",  category: "memory",    emoji: "🎵", blurb: "Watch the colour song, then tap the same order back.",   unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 5–8" },
  { id: "color-memory",     title: "Color Memory",     category: "memory",    emoji: "🎨", blurb: "Hold the colour order in your mind, then replay it.",   unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 5–8" },
  { id: "speed-math",       title: "Speed Math",       category: "math",      emoji: "➕", blurb: "Friendly sums with a gentle timer — start Easy if it feels new.", unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 6–8" },
  { id: "number-match",     title: "Number Match",     category: "math",      emoji: "🔢", blurb: "Count the dots, then tap the matching number — early number sense.",         unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 3–6" },
  { id: "find-mistake",     title: "Find the Mistake", category: "focus",     emoji: "🕵️", blurb: "Look closely — one picture is different. Can you spot it?",     unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 6–8" },
  { id: "target-tap",       title: "Target Tap",       category: "action",    emoji: "🎯", blurb: "Tap glowing targets as they appear — practice calm, quick focus.",   unlockCost: 50, rewardMin: 5, rewardMax: 15, status: "ready", ageHint: "Ages 5–8" },
  { id: "what-should-you-do", title: "What Should You Do?", category: "behavior", emoji: "💛", blurb: "Real-life moments — choose the kind, brave, or helpful action.", unlockCost: 50, rewardMin: 8, rewardMax: 15, status: "ready", ageHint: "Ages 6–8" },
  { id: "spot-difference",  title: "Spot the Difference", category: "focus",     emoji: "👀", blurb: "Two almost-matching scenes — tap every change you notice.", unlockCost: 60, rewardMin: 5, rewardMax: 12, status: "ready", premiumOnly: true, ageHint: "Ages 6–8" },
  { id: "hidden-objects",   title: "Hidden Objects",      category: "focus",     emoji: "🔭", blurb: "Search the busy scene and find each listed treasure.", unlockCost: 60, rewardMin: 5, rewardMax: 12, status: "ready", premiumOnly: true, ageHint: "Ages 5–8" },
  { id: "color-fill",       title: "Color Fill",          category: "creativity",emoji: "🖍️", blurb: "Fill each cell to match the colour picture — calm creative focus.", unlockCost: 60, rewardMin: 5, rewardMax: 12, status: "ready", ageHint: "Ages 4–7" },
  { id: "shape-match",      title: "Shape Matching",      category: "creativity",emoji: "🔷", blurb: "See a shape, hear its name, tap the match — early geometry play.",        unlockCost: 60, rewardMin: 5, rewardMax: 12, status: "ready", ageHint: "Ages 3–6" },
  { id: "maze-escape",      title: "Maze Escape",         category: "action",    emoji: "🗺️", blurb: "Plan the path first, then guide your friend safely out.",  unlockCost: 60, rewardMin: 5, rewardMax: 12, status: "ready", ageHint: "Ages 5–8" },
];
