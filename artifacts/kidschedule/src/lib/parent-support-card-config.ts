...
> = {
  ...
  "life-skills": {
    ...
    ambientGlow:
      "radial-gradient(ellipse 75% 65% at 18% 45%, rgba(45,212,191,0.35), transparent 58%), radial-gradient(ellipse 65% 75% at 88% 42%, rgba(52,211,153,0.28), transparent 55%)",
    ...
    ctaShadow: "shadow-[0_0_20px_rgba(45,212,191,0.42)] group-hover:shadow-[0_0_28px_rgba(52,211,153,0.55)]",
  ...
  "ptm-prep": {
    ...
    ctaShadow: "shadow-[0_0_20px_rgba(59,130,246,0.42)] group-hover:shadow-[0_0_28px_rgba(99,102,241,0.55)]",
  ...
  "new-parent-tips": {
    ...
    surfaceGradient:
      "linear-gradient(135deg, rgba(30,27,75,0.62) 0%, rgba(49,46,129,0.54) 45%, rgba(88,28,135,0.46) 100%)",
    ambientGlow:
      "radial-gradient(ellipse 75% 65% at 18% 45%, rgba(129,140,248,0.32), transparent 58%), radial-gradient(ellipse 65% 75% at 88% 42%, rgba(168,85,247,0.25), transparent 55%)",
    ...
    ctaShadow: "shadow-[0_0_20px_rgba(129,140,248,0.4)] group-hover:shadow-[0_0_28px_rgba(168,85,247,0.5)]",
