...
function buildFeedingPage(months: number): ProgrammaticPageConfig {
  ...
  return {
    ...
    metaDescription: `Sample feeding plan for ${months}-month-olds — meal frequency, texture (${texture}), iron-rich foods, and hydration cues for Indian families.`,
    ...
    sections: [
      ...
      { type: "heading", text: "Sample foods (Indian context)" },
      {
        type: "list",
        items: [
          "Khichdi, dal mash, idli pieces, soft banana, stewed apple.",
      ...
      {
        type: "paragraph",
        text: "AmyNest Nutrition Hub suggests age-appropriate Indian meal ideas and tracks what your child accepts — reducing repeated mealtime guesswork.",
      },
    ],
    faqs: [
      {
