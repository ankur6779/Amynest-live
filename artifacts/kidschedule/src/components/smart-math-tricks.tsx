...
// ── Age 4–6 ────────────────────────────────────────────────────────────────
{
  ...
  practiceQ: {
    ...
    options: ["43", "44", "45", "46"],
    answer: "45",
    hint: "Add 1 to the tens digit: 3 becomes 4 → 45"
  }
}, {
  id: "t02",
  age: "4-6",
...
// ── Age 6–8 ────────────────────────────────────────────────────────────────
{
  ...
  practiceQ: {
    ...
    answer: "154",
    hint: "1 + 4 = 5, put 5 in middle → 154"
  }
}, {
  id: "m03",
  age: "6-8",
  ...
  practiceQ: {
    question: "What is 8 × 50?",
    options: ["300", "350", "400", "450"],
    answer: "400",
    hint: "8×100 = 800, ÷2 = 400"
  }
}, {
  id: "m08",
  age: "6-8",
  ...
  practiceQ: {
    question: "What is 100 − 63?",
    options: ["27", "37", "47", "57"],
    answer: "37",
    hint: "9−6=3, 10−3=7 → 37"
  }
}, {
  id: "m09",
  age: "6-8",
  ...
  practiceQ: {
    ...
    options: ["105", "115", "150", "151"],
    answer: "150",
    hint: "Add zero: 15 → 150"
  }
}, {
  id: "m14",
  age: "6-8",
  ...
  practiceQ: {
    ...
    options: ["70", "107", "700", "7000"],
    answer: "700",
    hint: "Add two zeros: 7 → 700"
  }
}, {
  id: "m15",
  age: "6-8",
  ...
  practiceQ: {
    question: "What is 56 + 99?",
    options: ["153", "154", "155", "156"],
    answer: "155",
    hint: "56+100=156, minus 1=155"
  }
}, {
  id: "m16",
  age: "6-8",
  ...
  practiceQ: {
    question: "What is 43 − 9?",
    options: ["32", "33", "34", "35"],
    answer: "34",
    hint: "43−10=33, plus 1=34"
  }
}, {
  id: "m17",
  age: "6-8",
  ...
  practiceQ: {
    ...
    options: ["110", "121", "131", "211"],
    answer: "121",
    hint: "11×11 = 121 — one, two, one!"
  }
}, {
  id: "m21",
  age: "6-8",
...
function TodayTab({
  ...
  return <div className="space-y-3">
      ...
      {todayTricks.map(t => <TrickCard key={t.id} trick={t} starred={starIds.includes(t.id)} onStar={() => onStar(t.id)} expanded={expanded === t.id} onToggle={() => setExpanded(prev => prev === t.id ? null : t.id)} showPractice />)}
...
export function SmartMathTricks({
  ...
  const handleStar = useCallback((id: string) => {
    setMathSt(prev => {
      const starIds = prev.starIds.includes(id) ? prev.starIds.filter(s => s !== id) : [...prev.starIds, id];
  ...
  return <div className="rounded-3xl overflow-hidden" style={{
    background: "linear-gradient(160deg,#451a03 0%,#1c0a00 100%)"
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-white/40 text-[11px] mt-0.5">
              {trickAge === "4-6" ? "Basic addition & counting tricks" : "Multiplication & mental math shortcuts"} {t("components.smart_math_tricks.age")} {trickAge}
            </p>
          </div>
      ...
      <div className="px-4 pb-4">
        {tab === "today" && <TodayTab pool={pool} childName={childName} starIds={mathSt.starIds} onStar={handleStar} />}
        {tab === "learn" && <LearnAllTab pool={pool} starIds={mathSt.starIds} onStar={handleStar} />}
        {tab === "practice" && <PracticeTab pool={pool} childName={childName} starIds={mathSt.starIds} onStar={handleStar} />}
      </div>
    </div>;
}