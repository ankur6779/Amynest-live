...
export function AmyMascotLogo({
  ...
  const rx = size * 0.585;
  const ey = size * 0.460;
  return <div className={`amy-mascot-outer ${className}`} style={{
    width: size,
    height: size,
    position: "relative",
    flexShrink: 0,
    display: "inline-block"
      ...
      <div className="amy-mascot-float" style={{
      width: size,
      height: size,
      position: "relative"
    }}>
        ...
        <div className="amy-mascot-shimmer" style={{
        position: "absolute",
        inset: 0,
        borderRadius: "50%",
        pointerEvents: "none",
        ...
        <div className="amy-mascot-hover-ring" style={{
        position: "absolute",
        inset: 0,
        borderRadius: "50%",
        pointerEvents: "none",
        ...
        <div className="amy-mascot-glow" style={{
        position: "absolute",
        inset: 0,
        borderRadius: "50%",
        overflow: "hidden",
        zIndex: 1
          ...
          <img src={mascotImg} alt={t("components.amy_mascot_logo.amy_ai")} style={{
          width: "100%",
          height: "100%",
          objectFit: "cover",
        ...
        height: eh,
        borderRadius: "50%",
        background: "hsl(var(--brand-red-100))",
        transform: "scaleY(0)",
