...
/** Premium expandable hub section for Stories & Communication tiles. */
export function StoriesPremiumSection({
  id,
  title,
  description,
  defaultOpen = false,
  ...
  return (
    <div data-section-id={id} className="w-full">
      <HubTileButton
        onClick={toggle}
