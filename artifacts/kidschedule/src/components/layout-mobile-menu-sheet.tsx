  ...
  const sheet =
    !userLoaded || !user ? (
      <div className="drawer-overlay md:hidden" role="dialog" aria-modal="true">
        ...
        />
        <aside className="drawer flex flex-col bg-card text-card-foreground shadow-2xl">
      ...
      <div className="drawer-overlay md:hidden" role="dialog" aria-modal="true">
        ...
        />
        <aside className="drawer flex flex-col bg-card text-card-foreground shadow-2xl">
          <div className="flex shrink-0 items-center gap-3 border-b px-4 pb-4 pt-4">
          ...
          <nav className="flex flex-1 flex-col gap-1 overflow-y-auto px-4 py-2 text-card-foreground">
          ...
          <div className="mobile-menu-sheet-footer shrink-0 border-t px-4 py-3">
            <button
              ...
              className="flex min-h-10 w-full items-center gap-3 rounded-lg px-3 py-2 text-foreground/70 transition-colors hover:bg-muted hover:text-foreground"
            >
              <LogOut className="h-5 w-5" />
              {t("nav.sign_out")}
            </button>
            <p className="mt-2.5 text-center text-[9px] font-bold uppercase tracking-widest text-primary/30">
