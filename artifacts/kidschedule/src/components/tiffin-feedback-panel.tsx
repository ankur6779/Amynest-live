...
export function TiffinFeedbackPanel({
  ...
  return <div className="mx-3 mt-3 rounded-2xl border border-border dark:border-border bg-gradient-to-br from-muted via-white to-muted dark:from-card dark:via-muted dark:to-card overflow-hidden">
      ...
      <div className="px-3.5 py-3">
        {todayDone && todayEntry ? <div className="flex items-center gap-2.5 rounded-xl bg-white/80 dark:bg-card border border-border dark:border-border px-3 py-2">
            ...
            <button onClick={undoToday} className="text-[11px] text-muted-foreground hover:text-primary inline-flex items-center gap-1" data-testid="tiffin-undo">
            ...
            <div className="flex flex-col sm:flex-row gap-2 items-stretch sm:items-center">
              <select value={pickedMealId} onChange={e => setPickedMealId(e.target.value)} className="flex-1 h-8 text-[12px] rounded-lg border border-border bg-white dark:bg-card px-2 focus:outline-none focus:border-border" data-testid="tiffin-meal-picker">
