 ...
 * Audio playback uses ElevenLabs via the shared /api/tts/synthesize
 * pipeline — the server caches each MP3 by content hash so every poem
 * is generated by a real human voice ONCE GLOBALLY, then served from
 * cache to every user. Per-user cost stays effectively zero.
 *
 * Composition:
