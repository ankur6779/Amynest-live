...
import {
  ...
  Play, Pause, ChevronDown, Repeat, Volume2, Clock, Plus, Loader2,
  type LucideIcon,
} from "lucide-react";
...
// ─────────────────────────────────────────────────────────────────────────────
function PoemTile({
  poem, isActive, isPlaying, isLoading, onPress,
}: {
  poem: InfantPoem;
  isActive: boolean;
  isPlaying: boolean;
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between">
        <div className="flex items-start justify-between">
          ...
          {isLoading ? (
            <span className="text-[9px] font-bold uppercase tracking-wider bg-white/25 backdrop-blur-sm px-1.5 py-0.5 rounded-full inline-flex items-center gap-1">
      ...
      {open && poem && (
        ...
        >
          ...
          <div className="relative w-full max-w-md mx-auto flex flex-col px-5 py-6 text-white">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <button
                onClick={() => {
                  ...
                  if (!player.isPlaying) {
                    void player.play({ text: poem.lines.join(" "), audioUrl: poem.audioUrl });
                ...
                className="h-16 w-16 rounded-full bg-white text-slate-900 flex items-center justify-center shadow-2xl hover:scale-105 active:scale-95 transition-transform disabled:opacity-80"
              >
                {player.isLoading
            ...
            {player.error && (
              <p
                className="text-[11px] text-rose-200 text-center mt-3"
                data-testid="poem-error"
              >
                Couldn't load audio. Tap play to try again.
              </p>
            )}
          </div>
        </motion.div>
