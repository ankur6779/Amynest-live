/**
 * TEMPORARY low-precision Meeus-style solar/lunar calculator.
 *
 * Used only by `infrastructure/ephemeris/astro-lite-adapter.ts`.
 * Do not import from UI or Reveal — use EphemerisPort / hydrateSkySnapshot.
 *
 * @temporary Replaced when Swiss Ephemeris adapter is certified.
 */
