...
export function BirthSkyUnavailable({
  ...
  return (
    <BirthSkyModuleShell title="Birth Sky" onBack={onExit} testId="birth-sky-unavailable">
      <div className="flex flex-col items-center px-2 py-16 text-center">
        ...
        <h2 className="mt-4 font-quicksand text-2xl font-bold">Birth Sky is unavailable</h2>
