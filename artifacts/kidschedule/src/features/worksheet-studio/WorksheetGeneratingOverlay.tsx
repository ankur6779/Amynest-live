...
export function WorksheetGeneratingOverlay({ message = "Creating your worksheet…" }: Props) {
  return (
    <div className={cn(WS_OVERLAY, "z-50 items-center bg-[#1e3a5f]/20 backdrop-blur-sm")} role="status" aria-live="polite" aria-labelledby="worksheet-generating-msg">
      <div className={cn(WS_GLASS_CARD, "mx-auto flex w-full min-w-0 max-w-sm flex-col items-center gap-4 px-8 py-10")}>
        ...
        <p className={cn("text-center text-sm", WS_MUTED_TEXT)}>Usually under 20 seconds</p>
