      ...
      <DialogContent className={cn(WS_DIALOG)}>
        ...
        <div className="space-y-3 rounded-xl border border-[#d4cfc4]/50 bg-[#faf8f5] p-4 text-sm">
          <div>
            ...
            <p className="mt-1 text-[#1e3a5f]/70">Your worksheet stays as-is until you accept.</p>
          </div>
          <div className="border-t border-[#d4cfc4]/40 pt-3">
            <p className="text-xs font-bold uppercase tracking-wider text-[#c9a227]">Suggested</p>
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-col">
          <Button className={cn(WS_PRIMARY_BTN, "w-full")} onClick={onAccept}>Accept changes</Button>
