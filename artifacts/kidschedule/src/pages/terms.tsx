...
const sections = [{
  ...
  body: `Certain features require a paid subscription ("Premium"). Subscription fees are charged in advance for the billing interval you select (monthly, six-month, or annual). Store purchases (Apple App Store and Google Play) are billed and cancelled through that store; refunds follow the store's policy and applicable law. Web purchases billed by AmyNest can be cancelled from your account before the next renewal; the current paid period remains available until it ends. We do not promise refunds beyond what the store or applicable law requires. We reserve the right to change pricing with 30 days' notice. Failure to pay may result in suspension or downgrade of your account to the free tier. You can restore a previous store purchase from the paywall.`
}, {
  title: "6. Free Trial",
  ...
  return <div className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border bg-card shadow-sm">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-4">
          ...
          <Link href="/">
            <span className="text-sm text-muted-foreground hover:text-foreground cursor-pointer">← {t("screens.common.home_link")}</span>
          </Link>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-5 py-12">
        ...
        <p className="mb-8 text-sm text-muted-foreground italic">{t("screens.terms.last_updated")}</p>
        ...
        <p className="my-3 leading-relaxed text-foreground">
          ...
          <a href="https://amynest.in" className="text-primary underline hover:text-primary/80">
