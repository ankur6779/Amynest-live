...
export default function AmyAiTutorPage() {
  ...
  return (
    <div
      className="assistant-chat-page chat-container relative mx-auto flex min-h-0 w-full max-w-3xl flex-1 flex-col bg-background"
      ...
      >
        ...
        {limitReached && (
          <Link href="/pricing">
            <Button
              size="sm"
              className="shrink-0 gap-1.5 rounded-full bg-primary text-white hover:bg-primary"
