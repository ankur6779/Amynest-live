...
describe("parent_hub copy roundtrips through English", () => {
  const HUB_KEYS = [
    ...
    "parent_hub.web_tiles.discovery-worlds.title",
    "parent_hub.web_tiles.discovery-worlds.description",
    "parent_hub.web_tiles.animal-world.title",
    "parent_hub.web_tiles.animal-world.description",
