# Release Intelligence Review: simulate-child-form

> Generated: 2026-06-06T18:27:35.494Z
> Base: `simulate` → Head: `simulate`
> **Read-only analysis** — engineers make all deploy decisions.

## Verdict

**HIGH_RISK** — Release Risk Score: **83/100**
...
| `artifacts/kidschedule/src/lib/child-form-hydration.ts` | HIGH | 68 | +45/-12 | ChildForm|MaximumDepth|InfantEffect, ChildForm|MaximumDepth|ChildForm |
...
- artifacts/kidschedule/src/lib/child-form-hydration.ts (risk 68, HIGH)
