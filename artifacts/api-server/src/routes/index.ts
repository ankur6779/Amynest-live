...
import customActivitiesRouter from "./custom-activities";
...
import appVersionPolicyRouter from "./app-version-policy";
...
import featureNotificationSchedulesRouter from "./feature-notification-schedules";
...
import { staticAudioPublicRouter, staticAudioAuthRouter } from "./static-audio";
import audioLessonsRouter from "./audio-lessons";
import audioWarmupRouter from "./audio-warmup";
import phonicsRouter, { phonicsPublicRouter } from "./phonics";
import phonicsV3ProgressRouter from "./phonics-v3-progress";
...
import healthLabRouter from "./health-lab";
...
import nutritionTrackRouter from "./nutrition-track";
import nutritionMemoryRouter from "./nutrition-memory";
import nutritionCaregiverShareRouter, {
  nutritionSharePublicRouter,
} from "./nutrition-caregiver-share";
...
import infantSleepCoachRouter from "./infant-sleep-coach";
import infantFeedingPlanRouter from "./infant-feeding-plan";
...
import speechCoachV2Router from "./speech-coach-v2";
import speechCoachV2DebugRouter from "./speech-coach-v2-debug";
import openaiRealtimeInfraRouter from "./openai-realtime-infra";
...
import growthAdminRouter from "./growth-admin";
import speechCoachV2CostAdminRouter from "./speech-coach-v2-cost-admin";
import crashIntelligenceRouter from "./crash-intelligence";
...
router.use(routineFeedbackRouter);
...
router.use(featureNotificationSchedulesRouter);
router.use(recipesRouter);
router.use(ttsRouter);
router.use(audioLessonsRouter);
router.use(audioWarmupRouter);
router.use(phonicsRouter);
router.use(phonicsV3ProgressRouter);
router.use(abacusRouter);
router.use(healthLabRouter);
...
router.use(nutritionTrackRouter);
router.use(nutritionMemoryRouter);
router.use(nutritionCaregiverShareRouter);
...
router.use(infantSleepCoachRouter);
router.use(infantFeedingPlanRouter);
...
router.use(speechCoachV2Router);
...
router.use(growthAdminRouter);
router.use(speechCoachV2CostAdminRouter);
